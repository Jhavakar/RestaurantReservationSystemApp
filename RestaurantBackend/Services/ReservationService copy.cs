...
//             // Ensure the reservation time is within operating hours using custom validation
...
//                 return null; // Or return an appropriate error message indicating the slot is taken
//             }
