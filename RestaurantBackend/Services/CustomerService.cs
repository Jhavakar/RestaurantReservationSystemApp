...
namespace RestaurantBackend.Services
{
    ...
    {
        Task AddCustomer(CustomerVM customerVM);
    ...
    public class CustomerService : ICustomerService
    {
        ...
        {
            var customerExists = await _context.Customers.AnyAsync(c => c.EmailAddress == customerVM.EmailAddress);
            if (customerExists)
            {
            ...
            CreatePasswordHash(customerVM.Password, out byte[] passwordHash, out byte[] passwordSalt);
